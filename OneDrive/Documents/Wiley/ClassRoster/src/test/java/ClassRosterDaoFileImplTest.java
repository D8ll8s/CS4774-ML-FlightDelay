...
public class ClassRosterDaoFileImplTest {
    ...
    public void testAddGetStudent() throws Exception {
        ...
        Assertions.assertEquals(student.getCohort(),
    ...
    public void testAddGetAllStudents() throws Exception {
        ...
        Assertions.assertNotNull(allStudents, "The list of students must not null");
        Assertions.assertEquals(2, allStudents.size(),"List of students should have 2 students.");

        // Then the specifics
        Assertions.assertTrue(testDao.getAllStudents().contains(firstStudent),
                "The list of students should include Ada.");
        Assertions.assertTrue(testDao.getAllStudents().contains(secondStudent),
    ...
    public void testRemoveStudent() throws Exception {
        ...
        Assertions.assertEquals(removedStudent, firstStudent, "The removed student should be Ada.");

        // Get all the students
        List<Student> allStudents = testDao.getAllStudents();

        // First check the general contents of the list
        Assertions.assertNotNull( allStudents, "All students list should be not null.");
        Assertions.assertEquals( 1, allStudents.size(), "All students should only have 1 student.");

        // Then the specifics
        Assertions.assertFalse( allStudents.contains(firstStudent), "All students should NOT include Ada.");
        Assertions.assertTrue( allStudents.contains(secondStudent), "All students should NOT include Charles.");

        // Remove the second student
        removedStudent = testDao.removeStudent(secondStudent.getStudentId());
        // Check that the correct object was removed.
        Assertions.assertEquals( removedStudent, secondStudent, "The removed student should be Charles.");

        // retrieve all of the students again, and check the list.
        allStudents = testDao.getAllStudents();

        // Check the contents of the list - it should be empty
        Assertions.assertTrue( allStudents.isEmpty(), "The retrieved list of students should be empty.");
        ...
        Assertions.assertNull(retrievedStudent, "Ada was removed, should be null.");

        retrievedStudent = testDao.getStudent(secondStudent.getStudentId());
        Assertions.assertNull(retrievedStudent, "Charles was removed, should be null.");
